...
public class PushMessageReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.getAction().equals(PushConstants.ACTION_MESSAGE)) {
			...
			L.d(TAG, "msgSize=" + ehList.size() + " title=" + title + " content=" + content);
			...
			L.e(TAG, "Unknown intent action: " + intent.getAction());
		}
	}
	...
	private void Parse(String message) {
		...
		try {
			tag = JsonUtil.getTag(message);
			userId = JsonUtil.getFromUserId(message);
			headId = Integer.parseInt(JsonUtil.getFromUserHead(message));
		} catch (Exception e) {
			L.e("Message is not JSON format");
		}
